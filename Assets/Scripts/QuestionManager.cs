        ...
        {
            {
                "JavaScript", new Dictionary<int, List<Question>> {
                    ...
                    { 4, new List<Question> {
                        ...
                        new Question("How do you create a string?", new string[] { "let str = '';", "let str = '';", "let str = 5;", "let str = (5);" }, 1, "Strings are created with either single or double quotes, e.g., 'let str = ''Hello'';'."),
            ...
            },
            {
                "Java", new Dictionary<int, List<Question>> {
                   { 1, new List<Question> {
                        ...
                        new Question("Which of the following is the correct syntax to call a method?", new string[] { "method()", "call method()", "method.call()", "method;()" }, 0, "The correct way to call a method is 'method();'."),
                    ...
                    { 2, new List<Question> {
                        ...
                        new Question("What is the difference between '== 'and '.equals()' in Java?", new string[] { "'==' compares object references, '.equals()' compares values", "'==' compares values, '.equals()' compares references", "'==' and '.equals()' are the same", "None of the above" }, 0, "'==' compares object references, while '.equals()' compares object values."),
                    ...
                    { 3, new List<Question> {
                        ...
                        new Question("What is the purpose of the 'super()' constructor in Java?", new string[] { "To call a constructor from the parent class", "To call the current class constructor", "To initialize a variable", "None of the above" }, 0, "'super()' calls the constructor of the parent class in Java."),
            ...
            },
            {
                "C#", new Dictionary<int, List<Question>> {
                    { 1, new List<Question> {
                        ...
                        new Question("Which keyword is used to create a subclass in C#?", new string[] { "inherits", "extends", "base", ":", "None of the above" }, 3, "In C#, the ':' character is used to indicate inheritance when creating a subclass from a base class."),
                        new Question("Which of the following is not a valid access modifier in C#?", new string[] { "public", "private", "protected", "internal", "exclusive" }, 4, "'exclusive' is not a valid access modifier in C#."),
                    ...
                    { 2, new List<Question> {
                        ...
                        new Question("What is the difference between '==' and '!=' in C#?", new string[] { "'==' checks equality, '!=' checks inequality", "'==' checks inequality, '!=' checks equality", "Both check equality", "None of the above" }, 0, "'==' checks if two values are equal, while '!=' checks if they are not equal."),
                    ...
                    { 3, new List<Question> {
                        new Question("What is the difference between '==' and '.Equals()' in C#?", new string[] { "'==' compares references, '.Equals()' compares values", "'==' compares values, '.Equals()' compares references", "Both are the same", "None of the above" }, 0, "'==' checks if two object references point to the same memory, while '.Equals()' compares object values."),
                        ...
                        new Question("What is the difference between 'readonly' and 'const' in C#?", new string[] { "'readonly' can be assigned in the constructor, 'const' cannot", "'const' can be assigned in runtime, 'readonly' cannot", "They are the same", "None of the above" }, 0, "'readonly' can be assigned in the constructor, while 'const' must be assigned at declaration."),
                        ...
                        new Question("What will 'string.IsNullOrEmpty(\"\")' return in C#?", new string[] { "true", "false", "null", "Error" }, 0, "'string.IsNullOrEmpty(\"\")' returns true because the string is empty."),
            ...
            },
            {
                "Python", new Dictionary<int, List<Question>> {
                    ...
                    { 3, new List<Question> {
                        ...
                        new Question("Which of the following is NOT a valid way to create a dictionary?", new string[] { "{'a': 1, 'b': 2}", "dict(a=1, b=2)", "dict['a':1, 'b':2]", "{('a', 1), ('b', 2)}" }, 2, "The correct ways to create a dictionary are '{'a':1, 'b':2}' or 'dict(a=1, b=2)'."),
